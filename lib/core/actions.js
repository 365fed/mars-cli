  ...
  res.then(async res => {
    ...
    try {
      ...
      switch (Number(type)) {
        case 1:
          // pc
          downloadRepo(repoConfig.vueGitRepo, name,handleError);
          break;
        case 2:
          // h5
          downloadRepo(repoConfig.vueH5GitRepo, name,handleError);
          break;
        case 3:
          // ssr
          downloadRepo(repoConfig.vueSsrGitRepo, name,handleError);
          break;
        case 4:
          // anything
